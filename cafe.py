...
root.title("Cafe Nutrition Billing System")
...
lblInfo = Label(Tops, font=('arial', 20, 'bold'), fg="brown",text="< Cafe Nutrition >", bd=10, anchor='w')
lblInfo.grid(row=0, column=0)
lblcopyright = Label(Bottoms, font=('arial', 10, 'italic'),fg="brown", text="Created by Bhargav, Shantanu, Abhinav", bd=0, anchor='w')
